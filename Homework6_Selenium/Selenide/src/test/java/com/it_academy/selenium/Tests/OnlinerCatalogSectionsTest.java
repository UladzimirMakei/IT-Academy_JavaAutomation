...
public class OnlinerCatalogSectionsTest extends BaseTest {
    ...
    public void testOnlinerCatalogContainsSpecificSection() {
        List<String> onlinerCatalogElements = ONLINER_HOME_PAGE
                ...
                .getCatalogItemsList();
        assertThat(onlinerCatalogElements.containsAll(CATALOG_PAGE.getCatalogItemTitlesCollection()))
                .as("Onliner catalog section does not contain required titles").isTrue();
    }
    ...
    public void testOnlinerCatalogContainsFoodSection() {
        List<String> onlinerCatalogElements = ONLINER_HOME_PAGE
                .clickOnHeaderLink("Каталог")
                .getCatalogItemsList();
        assertThat(onlinerCatalogElements.contains("Еда")).
                as("Onliner catalog section does not contain 'Еда'").isFalse();
    }
}